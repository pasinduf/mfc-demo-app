            ...
            <div className="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
              <div className="flex w-full flex-col sm:flex-row flex-wrap gap-2 sm:gap-5">
                ...
                <div className="w-full sm:w-auto">
                  <div className="flex w-full sm:w-auto rounded-md bg-whiter p-1 dark:bg-meta-4">
                    <div className="grid grid-cols-2 w-full sm:flex sm:w-auto gap-1">
                      <button
                        onClick={() => changeType('daily')}
                        className={`w-full rounded py-2 px-4 text-xs font-medium transition
                        ${
                          type === 'daily'
                            ? 'bg-primary text-white shadow-card'
                            : 'bg-white text-black hover:bg-gray-50 dark:bg-boxdark dark:text-white'
                        }`}
                          >
                            Day
                          </button>
