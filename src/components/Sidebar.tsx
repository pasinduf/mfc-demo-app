...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const allowSideNav = (allowedAccess: string[]) => {
    return auth?.access?.find((access: any) => allowedAccess.includes(access));
  };
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <img src={Cover} alt="Logo" className='w-80 h-15' />
        </NavLink>
        ...
        <nav className="mt-5  px-4 lg:mt-2 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {allowSideNav([Main_Dashboard, Collector_Dashboard]) && (
                <li>
                  <NavLink
                    to="/"
              ...
              {allowSideNav([View_Loan_Product]) && (
                <li>
                  <NavLink
                    to="/products"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              {allowSideNav([View_Loan]) && (
                <li>
                  <NavLink
                    to="/loans"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('loans') && 'bg-graydark dark:bg-meta-4'
                    }`}
                  >
              ...
              {allowSideNav([Collector_Dashboard]) && (
                <li>
                  <NavLink
                    to="/collections"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                  ...
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        ...
                        >
                          <ul className="mt-4 mb-1 flex flex-col gap-2.5 pl-6">
                            <li>
                              <NavLink
                                to="/"
                                className={({ isActive }) =>
